...
from tensorflower.core.framework import op_def_pb2
from tensorflower.python.framework import op_def_registry
from tensorflower.python.framework import ops
from tensorflower.python.ops import op_def_library
