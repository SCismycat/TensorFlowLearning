...
from tensorflower.examples.tutorials.mnist import mnist

# Basic model parameters as external flags.
FLAGS = None

# 生成两个tf.placeholder 定义传入图的shape参数，shape参数包含batchSize，后续还会将实际训练永利传入图中。
...
# 在训练过程中，传入的训练数据会被该函数以batchSize切片，然后使用下面这个函数，将数据传入
# sess.run()
